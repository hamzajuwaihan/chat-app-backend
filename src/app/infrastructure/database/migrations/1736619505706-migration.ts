...
export class Migration1736619505706 implements MigrationInterface {
    name = 'Migration1736619505706'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."profiles_status_enum" AS ENUM('available', 'busy', 'away')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."rooms_visibility_enum" AS ENUM('public', 'private', 'on-request')`);
        await queryRunner.query(`CREATE TYPE "public"."rooms_owner_type_enum" AS ENUM('system', 'user')`);
        ...
        await queryRunner.query(`ALTER TABLE "rooms" ADD CONSTRAINT "FK_3ef3bcea50af2dffe5a49407035" FOREIGN KEY ("country_id") REFERENCES "countries"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "room_memberships" ADD CONSTRAINT "FK_f32bd199eb196f84d0893a3054d" FOREIGN KEY ("room_id") REFERENCES "rooms"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "room_memberships" ADD CONSTRAINT "FK_69395a6306f92243ffda7ea113a" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_feature_permissions" ADD CONSTRAINT "FK_ec0df1e14f470d661a81c8910d5" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_feature_permissions" ADD CONSTRAINT "FK_5571e48bab8f18897c9ec408c1b" FOREIGN KEY ("allowed_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_feature_permissions" DROP CONSTRAINT "FK_5571e48bab8f18897c9ec408c1b"`);
        await queryRunner.query(`ALTER TABLE "user_feature_permissions" DROP CONSTRAINT "FK_ec0df1e14f470d661a81c8910d5"`);
        await queryRunner.query(`ALTER TABLE "room_memberships" DROP CONSTRAINT "FK_69395a6306f92243ffda7ea113a"`);
        await queryRunner.query(`ALTER TABLE "room_memberships" DROP CONSTRAINT "FK_f32bd199eb196f84d0893a3054d"`);
        await queryRunner.query(`ALTER TABLE "rooms" DROP CONSTRAINT "FK_3ef3bcea50af2dffe5a49407035"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."room_messages_message_type_enum"`);
        await queryRunner.query(`DROP TABLE "private_messages"`);
        await queryRunner.query(`DROP TYPE "public"."private_messages_message_type_enum"`);
        await queryRunner.query(`DROP TABLE "user_feature_permissions"`);
        await queryRunner.query(`DROP TYPE "public"."user_feature_permissions_permissiontype_enum"`);
        await queryRunner.query(`DROP TABLE "users"`);
        await queryRunner.query(`DROP TABLE "room_memberships"`);
        await queryRunner.query(`DROP TYPE "public"."room_memberships_role_enum"`);
        await queryRunner.query(`DROP TABLE "rooms"`);
        await queryRunner.query(`DROP TYPE "public"."rooms_owner_type_enum"`);
        await queryRunner.query(`DROP TYPE "public"."rooms_visibility_enum"`);
