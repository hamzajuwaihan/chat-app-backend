...
export class Migration1736626404092 implements MigrationInterface {
    name = 'Migration1736626404092'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "room_memberships" ADD CONSTRAINT "FK_f32bd199eb196f84d0893a3054d" FOREIGN KEY ("room_id") REFERENCES "rooms"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "room_memberships" ADD CONSTRAINT "FK_69395a6306f92243ffda7ea113a" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
